...
# Налаштування UTF-8 для коректного відображення кирилиці в консолі Windows
if sys.platform == "win32":
    os.system('chcp 65001 > nul')
    sys.stdout.reconfigure(encoding='utf-8')
    sys.stdin.reconfigure(encoding='utf-8')

# Клас для окремої карти
class Card:
...
# Клас учасника гри (Гравець або Дилер)
class Hand:
    ...
    def get_value(self, game_type="blackjack"):
        # Помилка linter об'єднана в один clean if
